...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != _owner, "Already owner");
        _owner = newOwner;
...
contract Pausable is Ownable {
    ...
    modifier whenNotPaused() {
        require(_paused == false, "Has been paused");
        _;
    }

    modifier paused() {
        require(_paused == true, "Has not paused");
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(ownerOf(tokenId) != to, "Already owner of token");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
       //require(_isApprovedOrOwner(to, tokenId), "Only owner or approve for all");
        require(msg.sender == ownerOf(tokenId) || isApprovedForAll(msg.sender, to), "Only owner or approve for all");
    ...
    function getApproved(uint256 tokenId) public view returns (address) {
        ...
        require(_exists(tokenId), "Token ID is not exsit");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!_exists(tokenId), "Token ID already exsit");
        require(_checkOnERC721Received(address(0), to, tokenId, ""), "Given address is invalid");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, "Is not owner of Token ID");
        // TODO: require token is being transfered to valid address
        require(_checkOnERC721Received(from, to, tokenId, ""), "Given address is invalid");
        // TODO: clear approval
